...
//import com.crawljax.stateabstractions.visual.ColorHystogramStateVertexFactory;
//import com.crawljax.stateabstractions.visual.PHashStateVertexFactory;
//import com.crawljax.stateabstractions.visual.VisHashStateVertexFactory;
//import com.crawljax.stateabstractions.visual.hashes.BMHash;
//import com.crawljax.stateabstractions.visual.hashes.CMHash;
//import com.crawljax.stateabstractions.visual.hashes.PHash2;
...
//	public static final String URL = "http://amesbah-macpro.ece.ubc.ca:8888/claroline/claroline-1.11.10/";
	public static final String URL = "http://localhost/claroline-1.11.10/";
...
//		SimHashCrawljax.call();
		...
		CrawljaxRunner hybridCrawljax = new CrawljaxRunner(builder.build());
		hybridCrawljax.call();
		hybridCrawljax.stop();
		builder.setStateVertexFactory(new HybridStateVertexFactory(0, builder, VISUAL_DATA));
