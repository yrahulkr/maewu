...
import com.crawljax.examples.angularphonecat.PhonecatCrawlingRules;
import com.crawljax.examples.angularphonecat.PhonecatRunner;
import com.crawljax.examples.claroline.ClarolineCrawlingRules;
import com.crawljax.examples.claroline.ClarolineRunner;
import com.crawljax.examples.collabtive.CollabtiveCrawlingRules;
import com.crawljax.examples.collabtive.CollabtiveRunner;
...
import com.crawljax.examples.retroboard.RetroBoardCrawlingRules;
import com.crawljax.examples.retroboard.RetroBoardRunner;
import com.crawljax.examples.splittypie.SplittyPieCrawlingRules;
import com.crawljax.examples.splittypie.SplittyPieRunner;
...
public class StubMain {
	 ...
	 public static void main(String[] args) throws Exception {
            ...
            case "phoenix":
            	...
            	break;
            case "retroboard":
            	URL = RetroBoardRunner.URL;
            	break;
            case "splittypie":
            	URL = SplittyPieRunner.URL;
            	break;
        	case "collabtive":
                URL = CollabtiveRunner.URL;
                break;
        	case "ppma":
                URL = PpmaRunner.URL;
                break;
		...
		public static void run(String app, String saf, long runtime, double threshold, int maxStates, String URL) {
            ...
            case "pagekit":
            	...
            	visualData = PageKitRunner.VISUAL_DATA;
            	break;
            case "phoenix":
            	PhoenixCrawlingRules.setCrawlingRules(builder);
            	visualData = PhoenixRunner.VISUAL_DATA;
            	break;
            case "retroboard":
            	RetroBoardCrawlingRules.setCrawlingRules(builder);
            	break;
            case "splittypie":
            	SplittyPieCrawlingRules.setCrawlingRules(builder);
            	break;
            case "collabtive":
...
//				runtime=60;
			...
			builder.setBrowserConfig(new BrowserConfiguration(BrowserType.CHROME_HEADLESS), new BrowserOptions(BrowserOptions.MACBOOK_PRO_RETINA_PIXEL_DENSITY));
