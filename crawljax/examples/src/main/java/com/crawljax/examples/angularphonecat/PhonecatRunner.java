...
import com.crawljax.examples.StubMain;
 ...
 * @author astocco
 */
public final class PhonecatRunner {
...
//		
//		
//		builder.setStateVertexFactory(new LevenshteinStateVertexFactory());
...
//		PhonecatCrawlingRules.setCrawlingRules(builder);
//		builder.setStateVertexFactory(new TLSHStateVertexFactory(0.0, Mode.STRIPPED_DOM));
...
//		builder = CrawljaxConfiguration.builderFor(URL);
//		PhonecatCrawlingRules.setCrawlingRules(builder);
//		builder.setStateVertexFactory(new TLSHStateVertexFactory(0.025, Mode.STRIPPED_DOM));
...
//		builder = CrawljaxConfiguration.builderFor(URL);
//		PhonecatCrawlingRules.setCrawlingRules(builder);
//		builder.setStateVertexFactory(new TLSHStateVertexFactory(0.1, Mode.STRIPPED_DOM));
