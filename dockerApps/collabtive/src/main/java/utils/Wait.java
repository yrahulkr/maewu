...
public class Wait {
    private static final int DEFAULT_TIMEOUT_MILLISECONDS = 12000;
    ...
    public WebElement forElementThatChangesProperty(By by, String attributeName, String expectedValueAttribute, long customTimeout){
        return new CustomWebDriverWait(driver, customTimeout, TimeUnit.MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS)
                .until(new ExpectedConditionPropertyThatChanges(by, attributeName, expectedValueAttribute));
    }
